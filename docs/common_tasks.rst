...
Prerequisite: you must have previously exported credentials for all data source projects.

  .. code-block:: bash

      > ./manage.py export_project_credentials

Here's how to look up the credentials for ``mozilla-central``, for example:
