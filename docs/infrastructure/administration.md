...
GRANT SELECT, SELECT (id, username, email) ON treeherder.auth_user to 'myuser';
...
GRANT SELECT ON treeherder.changelog_entry to 'myuser';
GRANT SELECT ON treeherder.changelog_file to 'myuser';
