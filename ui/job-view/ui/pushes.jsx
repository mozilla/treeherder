...
class JobsAndGroups extends React.Component {
  render() {
    return (
  ...
  render() {
    return (
      ...
      >
        ...
        <JobsAndGroups groups={this.props.platform.groups}
                       $injector={this.props.$injector}
        />
      </tr>
    );
    ...
    return (
      <table id={this.aggregateId} className="table-hover">
        ...
        {platforms ? Object.keys(platforms).map((id, i) => (
          ...
          <PlatformRow platform={platforms[id]}
                       $injector={this.props.$injector}
                       key={id}
                       ref={id}
                       refOrder={i}
...
treeherder.component('push', react2angular(Push,
                                           ['push'],
                                           ['$injector', 'store']));
