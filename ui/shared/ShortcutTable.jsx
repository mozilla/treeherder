...
class ShortcutTable extends React.Component {
  constructor(props) {
    ...
    this.setOnscreenShortcutsShowing = this.setOnscreenShortcutsShowing.bind(this);
  }

  setOnscreenShortcutsShowing() {
    this.$rootScope.setOnscreenShortcutsShowing(false);
  }

  render() {
    const { onscreenShortcutsShowing } = this.props;
      ...
      <div className="card">
        <div className="card-header">
          <h3>Keyboard shortcuts
            ...
            {
              onscreenShortcutsShowing &&

              <span onClick={this.setOnscreenShortcutsShowing} className="pull-right" title="Close this help">
                <span className="fa fa-times lightgray onscreen-shortcuts-close" />
              </span>
            }
          </h3>
        </div>
...
ShortcutTable.propTypes = {
  ...
  onscreenShortcutsShowing: PropTypes.bool,
};

ShortcutTable.defaultProps = {
  $injector: null,
  onscreenShortcutsShowing: false,
};

treeherder.component('shortcutTable', react2angular(
    ShortcutTable,
    ['onscreenShortcutsShowing'],
    ['$injector']));
