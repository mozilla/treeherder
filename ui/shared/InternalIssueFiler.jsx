...
export function InternalIssueFilerClass({
  isOpen,
  toggle,
  suggestion,
  jobGroupName,
  ...
  const [summary, setSummary] = useState(() =>
    computeInitialSummary(suggestion, jobGroupName, jobTypeName),
  );
  ...
  return (
    <div>
      <Modal show={isOpen} onHide={toggle} size="lg">
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={submitInternalIssue}>
