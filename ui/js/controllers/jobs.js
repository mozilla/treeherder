...
treeherderApp.controller('ResultSetCtrl', [
    ...
    function ResultSetCtrl(
        ...
        $scope.triggerAllTalosJobs = function(revision) {
            ...
            ThResultSetStore.getGeckoDecisionTaskID($scope.repoName, $scope.resultset.id).then(function(decisionTaskID) {
                ThResultSetModel.triggerAllTalosJobs($scope.resultset.id, $scope.repoName, times, decisionTaskID).then(function(msg) {
