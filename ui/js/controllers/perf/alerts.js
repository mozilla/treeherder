    ...
    function AlertsCtrl($state, $stateParams, $scope, $rootScope, $http, $q,
        ...
        $scope.filtersUpdated = function() {
            ...
            $state.transitionTo('alerts', {
                status: $scope.filterOptions.status.id,
            ...
            if (statusFilterChanged || frameworkFilterChanged) {
                // if the status or framework filter changed, we should reload everything
                $scope.alertSummaries = undefined;
