    ...
    function() {
        var thTabs = {
            ...
            "showTab" : function(tab, job){
                ...
                if(angular.isUndefined(thTabs.tabs[thTabs.selectedTab].job) ||
                   !_.isEqual(thTabs.tabs[thTabs.selectedTab].job, job)) {
                    if (angular.isFunction(thTabs.tabs[thTabs.selectedTab].update)) {
                        thTabs.tabs[thTabs.selectedTab].job = job;
