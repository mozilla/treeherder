...
CompareTableRow.propTypes = {
  ...
  rowLevelResults: PropTypes.shape({
    ...
    confidenceTextLong: PropTypes.string,
    delta: PropTypes.number,
    deltaPercentage: PropTypes.number,
    isNoiseMetric: PropTypes.bool,
    isRegression: PropTypes.bool,
    isImprovement: PropTypes.bool,
    links: PropTypes.arrayOf(PropTypes.shape({})),
    magnitude: PropTypes.number,
    name: PropTypes.string,
    newIsBetter: PropTypes.bool,
    newValue: PropTypes.number,
    newRuns: PropTypes.arrayOf(PropTypes.number),
    newRetriggerableJobId: PropTypes.number,
    newStddev: PropTypes.number,
    newStddevPct: PropTypes.number,
    originalRuns: PropTypes.arrayOf(PropTypes.number),
    originalValue: PropTypes.number,
    originalStddev: PropTypes.number,
    originalStddevPct: PropTypes.number,
  }).isRequired,
};
