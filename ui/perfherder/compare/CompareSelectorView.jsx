          ...
          <div className="mx-auto">
            ...
            <Row className="justify-content-center">
              <SelectorCard
                ...
                title="Base"
                checkbox
                text="If checked, you can choose a specific revision as a base.  Otherwise, Perfherder will compare against performance data gathered over the last 2 days from when new revision was pushed."
