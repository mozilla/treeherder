    ...
    ('Rev4 MacOSX Snow Leopard 10.6 mozilla-central talos svgr-snow',
     {'build_type': 'opt',
      ...
      'platform': {'arch': 'x86_64',
                   ...
                   'os_platform': 'osx-10-6',
                   'vm': False}}),
    ('Rev4 MacOSX Snow Leopard 10.6 mozilla-central talos other-snow',
     {'build_type': 'opt',
      'job_type': 'talos',
      'name': {'group_name': 'Talos Performance',
               'group_symbol': 'T',
    ...
    ('Rev4 MacOSX Snow Leopard 10.6 mozilla-central talos g1-snow-e10s',
     {'build_type': 'opt',
      ...
      'platform': {'arch': 'x86_64',
                   ...
                   'os_platform': 'osx-10-6',
                   'vm': False}}),
    ('Rev5 MacOSX Yosemite 10.10 mozilla-central talos g2-e10s',
     {'build_type': 'opt',
      'job_type': 'talos',
      'name': {'group_name': 'Talos Performance e10s',
               'group_symbol': 'T-e10s',
      ...
      'platform': {'arch': 'x86_64',
                   ...
                   'os_platform': 'osx-10-10',
                   'vm': False}}),
    ('Rev4 MacOSX Snow Leopard 10.6 mozilla-central talos other-snow-e10s',
     {'build_type': 'opt',
      'job_type': 'talos',
      'name': {'group_name': 'Talos Performance e10s',
               'group_symbol': 'T-e10s',
