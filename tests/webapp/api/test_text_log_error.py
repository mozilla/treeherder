...
def test_get_error(webapp, text_log_errors_failure_lines):
    """
    ...
    exp_failure_keys = ["id", "line", "line_number", "failure_line", "matches",
...
def test_update_error_mark_job(jm, test_job,
                               text_log_errors_failure_lines,
                               classified_failures,
                               test_user):
...
def test_update_error_ignore(test_job, jm, text_log_errors_failure_lines,
                             classified_failures, test_user):
...
def test_update_error_verify_new_bug(test_repository,
    ...
    assert failure_line.best_is_verified
    assert error_line.best_classification not in classified_failures
    assert error_line.best_is_verified
    assert error_line.best_classification.bug_number == 78910
