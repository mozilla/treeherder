...
def test_load_non_ascii_textlog_errors(test_project, eleven_jobs_stored):
                ...
                "steps": [
                    {
                        ...
                        'errors': [
                            {
                                "line": "07:51:28  WARNING - \xc3\x83".decode('utf-8'),
                                "linenumber": 1587
                            },
                            {
                                "line": "07:51:29  WARNING - \xf0\x9d\x90\x80".decode('utf-8'),
                                "linenumber": 1588
                            }
                        ]
                    }
    ...
    assert TextLogError.objects.get(line_number=1587).line == '07:51:28  WARNING - \xc3\x83'.decode('utf-8')
    assert TextLogError.objects.get(line_number=1588).line == '07:51:29  WARNING - <U+01D400>'.decode('utf-8')
