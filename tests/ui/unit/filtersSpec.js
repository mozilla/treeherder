...
describe('linkifyClassifications filter', function() {
    ...
    it('linkifies classifications', function() {
        ...
        // This keeps saying "repo is null"...
        //expect(linkifyClassifications('This 1234567890ab is linked', 'try')).toEqual('');
    });
});
...
/*
 * I don't know what the perfherder filters are supposed to do, but I can add stubs for them
describe('alertStatus filter', function() {
    var $filter;
    beforeEach(module('treeherder'));
    beforeEach(inject(function(_$filter_) {
        $filter = _$filter_;
    ...
    it('does some more things', function() {
        var alertStatus = $filter('alertStatus');
...
describe('displayPrecision filter', function() {
    ...
    it('does some extra things', function() {
        ...
        expect(displayPrecision('')).toEqual('');
    });
});
*/
