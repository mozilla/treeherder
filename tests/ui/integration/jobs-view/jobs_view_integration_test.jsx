...
describe('Jobs View Integration Tests', () => {
  ...
  describe('Job Filtering', () => {
    test('should show and hide field filter panel', async () => {
      ...
      const panelVisible = await isElementVisible('.active-filters-bar');
      ...
      const panelHidden = await isElementVisible('.active-filters-bar');
  ...
  describe('Job Selection and Details', () => {
    ...
    test('should show job actions in details panel', async () => {
      ...
      // Check for retry button when actions exist
      const retryButton = await isElementVisible('button[title*="Retrigger"]');
      // At least one of these should be visible
      expect(actionsExist || retryButton).toBeTruthy();
    });
  });
