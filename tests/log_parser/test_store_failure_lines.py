...
def test_store_failure_lines(activate_responses, jm, eleven_jobs_stored, initial_data):
...
def test_store_failure_lines_truncated(activate_responses, jm, eleven_jobs_stored,
