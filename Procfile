web: waitress-serve --port=$PORT treeherder.webapp.wsgi:application
worker: celery -A treeherder worker --concurrency 5 --maxtasksperchild=10
...
worker_pulse: python manage.py start_pulse_consumer --start --traceback
