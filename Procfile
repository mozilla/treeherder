...
worker_log_parser: newrelic-admin run-program celery -A treeherder worker -Q log_parser,log_parser_fail,log_parser_hp,log_parser_json,log_parser_json_fail,log_parser_json_hp,log_store_failure_lines,log_store_failure_lines_fail,log_store_failure_lines_hp,log_crossreference_error_lines,log_crossreference_error_lines_fail,log_crossreference_error_lines_hp,log_autoclassify,log_autoclassify_fail,log_autoclassify_hp,error_summary --maxtasksperchild=50 --concurrency=5
