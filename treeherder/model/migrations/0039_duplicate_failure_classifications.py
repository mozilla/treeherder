...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=treeherder.model.fields.FlexibleForeignKey(related_name='best_for_error', on_delete=django.db.models.deletion.SET_NULL, to='model.ClassifiedFailure', null=True),
        ),
        migrations.AddField(
            model_name='textlogerror',
        ...
        migrations.AddField(
            model_name='textlogerror',
            name='failure_line',
            field=treeherder.model.fields.FlexibleOneToOneField(related_name='_error', null=True, to='model.FailureLine'),
        ),
        migrations.AddField(
