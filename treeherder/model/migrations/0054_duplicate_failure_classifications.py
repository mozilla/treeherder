...
# --
# CREATE TABLE `text_log_error_match` (`id` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `score` numeric(3, 2) NULL, `classified_failure_id` bigint NOT NULL, `matcher_id` integer NOT NULL);
# --
# -- Add field best_classification to textlogerror
# --
# ALTER TABLE `text_log_error` ADD COLUMN `best_classification_id` bigint NULL;
# ALTER TABLE `text_log_error` ALTER COLUMN `best_classification_id` DROP DEFAULT;
# --
# -- Add field best_is_verified to textlogerror
# --
# ALTER TABLE `text_log_error` ADD COLUMN `best_is_verified` bool DEFAULT 0 NOT NULL;
# ALTER TABLE `text_log_error` ALTER COLUMN `best_is_verified` DROP DEFAULT;
# --
# -- Add field failure_line to textlogerror
# --
# ALTER TABLE `text_log_error` ADD COLUMN `failure_line_id` bigint NULL UNIQUE;
# ALTER TABLE `text_log_error` ALTER COLUMN `failure_line_id` DROP DEFAULT;
# --
# -- Add field text_log_error to textlogerrormatch
# --
# ALTER TABLE `text_log_error_match` ADD COLUMN `text_log_error_id` bigint NOT NULL;
# ALTER TABLE `text_log_error_match` ALTER COLUMN `text_log_error_id` DROP DEFAULT;
# --
...
# ALTER TABLE `text_log_error` ADD CONSTRAINT `text_lo_best_classification_id_5a40639a_fk_classified_failure_id` FOREIGN KEY (`best_classification_id`) REFERENCES `classified_failure` (`id`);
# ALTER TABLE `text_log_error` ADD CONSTRAINT `text_log_error_failure_line_id_c0d8c8b0_fk_failure_line_id` FOREIGN KEY (`failure_line_id`) REFERENCES `failure_line` (`id`);
