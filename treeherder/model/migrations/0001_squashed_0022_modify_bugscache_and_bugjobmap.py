    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobGroupSymbol', models.CharField(blank=True, db_index=True, max_length=25)),
                ('jobTypeName', models.CharField(db_index=True, max_length=100)),
                ('jobTypeSymbol', models.CharField(blank=True, db_index=True, max_length=25)),
