...
class ReferenceDataSignatures(models.Model):
    ...
    jobGroupName = models.CharField(max_length=100, blank=True, db_index=True)
    jobGroupSymbol = models.CharField(max_length=25, blank=True, db_index=True)
    jobTypeName = models.CharField(max_length=100, db_index=True)
    jobTypeSymbol = models.CharField(max_length=25, blank=True, db_index=True)
