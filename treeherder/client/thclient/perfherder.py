...
class SignatureList(dict):
    ...
    def filter(self, *args):
        '''
        Returns a filtered subset of this collection of signatures, based on a set of key/value tuples
...
class Series(list):
    ...
    You can access the individual elements of the list by using the []
...
class PerfherderClient(TreeherderClient):
    ...
    def get_performance_signature_properties(self, project, signature,
        ...
        property_list = self._get_json(project, endpoint, timeout)
    ...
    def get_performance_series_list(self, project, signature_list,
        ...
        results = self._get_json(project, endpoint, timeout)
    ...
    def get_performance_series(self, project, signature,
                               time_interval=TimeInterval.WEEK, timeout=None):
        '''
