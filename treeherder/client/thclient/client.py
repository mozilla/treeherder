...
class TreeherderClient(object):
    ...
    def _post_json(self, project, endpoint, oauth_key, oauth_secret, jsondata,
        ...
        uri = self._get_project_uri(project, endpoint, data=jsondata, oauth_key=oauth_key,
    ...
    def get_option_collection_hash(self):
        ...
        """
        resp = self._get_json(None, OPTION_COLLECTION_HASH_ENDPOINT, None)
        ret = {}
        for result in resp:
    ...
    def get_repositories(self):
        ...
        """
        return self._get_json(None, REPOSITORY_ENDPOINT, None)
    ...
    def get_job_groups(self):
        ...
        """
        return self._get_json(None, JOBGROUP_ENDPOINT, None)
    ...
    def get_job_types(self):
        ...
        """
        return self._get_json(None, JOBTYPE_ENDPOINT, None)
