...
def load_perf_artifacts(project_name, reference_data, job_data, datum):
    ...
    for suite in perf_datum['suites']:
        ...
        for subtest in suite['subtests']:
            ...
            subtest_property.update(reference_data)
            subtest_properties.append(subtest_property)
        ...
        for property in subtest_properties:
            ...
            if summary_signature_hash is not None:
                property.update({'parent_signature': summary_signature_hash})
