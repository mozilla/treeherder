...
JOB_NAME_BUILDERNAME = [
    # ** Talos **
    {"regex": re.compile(r'talos remote-tcanvasmark$'), "name": "Talos canvasmark"},
    {"regex": re.compile(r'talos chromez(-snow)?-e10s$'), "name": "Talos chrome e10s"},
    {"regex": re.compile(r'talos chrome[z]?(-snow)?$'), "name": "Talos chrome"},
    {"regex": re.compile(r'talos dromaeojs-e10s$'), "name": "Talos dromaeojs e10s"},
    {"regex": re.compile(r'talos dromaeojs-metro$'), "name": "Talos dromaeojs Metro"},
    {"regex": re.compile(r'talos dromaeojs$'), "name": "Talos dromaeojs"},
    {"regex": re.compile(r'talos g1(-snow)?-e10s$'), "name": "Talos g1 e10s"},
    {"regex": re.compile(r'talos g1(-snow)?$'), "name": "Talos g1"},
    {"regex": re.compile(r'talos g2-e10s$'), "name": "Talos g2 e10s"},
    {"regex": re.compile(r'talos g2$'), "name": "Talos g2"},
    {"regex": re.compile(r'talos other(-snow)?-e10s'), "name": "Talos other e10s"},
    {"regex": re.compile(r'talos other-metro$'), "name": "Talos other Metro"},
    {"regex": re.compile(r'talos other'), "name": "Talos other"},
    {"regex": re.compile(r'talos dirtypaint$'), "name": "Talos paint"},
    {"regex": re.compile(r'talos remote-trobocheck2$'), "name": "Talos robocheck2"},
    {"regex": re.compile(r'talos remote-trobopan$'), "name": "Talos robopan"},
    {"regex": re.compile(r'talos remote-troboprovider$'), "name": "Talos roboprovider"},
    {"regex": re.compile(r'talos (?:remote-t)?svg[rx]?(-snow)?-e10s$'), "name": "Talos svg e10s"},
    {"regex": re.compile(r'talos (?:remote-t)?svg[rx]?-metro$'), "name": "Talos svg Metro"},
    {"regex": re.compile(r'talos (?:remote-t)?svg[rx]?(-snow)?$'), "name": "Talos svg"},
    {"regex": re.compile(r'talos tp5o-e10s$'), "name": "Talos tp e10s"},
    {"regex": re.compile(r'talos tp5o-metro$'), "name": "Talos tp Metro"},
    ...
    {"regex": re.compile(r'crashtest-ipc'), "name": "Crashtest IPC"},
    ...
    {"regex": re.compile(r'reftest-ipc'), "name": "Reftest IPC"},
    {"regex": re.compile(r'reftest-omtc'), "name": "Reftest OMTC"},
