...
JOB_NAME_BUILDERNAME = [
    ...
    {"regex": re.compile(r'talos quantum-pageload-stylo-e10s$'), "name": "Talos-Stylo tp6-stylo e10s"},
    {"regex": re.compile(r'talos tp6-e10s$'), "name": "Talos tp6 e10s"},
    {"regex": re.compile(r'talos tp6-stylo-e10s$'), "name": "Talos-Stylo tp6-stylo e10s"},
    {"regex": re.compile(r'talos tp6-stylo-threads-e10s$'), "name": "Talos-Stylo tp6-stylo-threads e10s"},
    # ** Unit tests **
...
GROUP_NAMES = {
    ...
    "Talos quantum-pageload-stylo e10s": "Talos Stylo Performance e10s",
    "Talos tp6 e10s": "Talos Performance e10s",
    "Talos-Stylo tp6-stylo e10s": "Talos Stylo Performance e10s",
    "Talos-Stylo tp6-stylo-threads e10s": "Talos Stylo Performance e10s",
...
SYMBOLS = {
    ...
    "Talos-Stylo quantum-pageload-stylo e10s": "tp6s",
    "Talos tp6 e10s": "tp6",
    "Talos-Stylo tp6-stylo e10s": "tp6s",
    "Talos-Stylo tp6-stylo-threads e10s": "tp6st",
    # Release Promotion Related Jobs
