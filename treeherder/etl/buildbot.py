...
JOB_NAME_BUILDERNAME = [
    ...
    {"regex": re.compile(r'talos g2-e10s$'), "desc": "Talos g2 e10s"},
    {"regex": re.compile(r'talos g2$'), "desc": "Talos g2"},
    ...
    {"regex": re.compile(r'spidermonkey.*-plain'), "desc": "SpiderMonkey Plain Shell Build"},
    ...
    {"regex": re.compile(r'spidermonkey.*-compacting'), "desc": "SpiderMonkey Compacting GC Shell Build"},
