...
JOB_NAME_BUILDERNAME = [
    ...
    {"regex": re.compile(r'talos g4(-osx)?-e10s$'), "name": "Talos g4 e10s"},
    {"regex": re.compile(r'talos g4(-osx)?$'), "name": "Talos g4"},
    {"regex": re.compile(r'talos g5(-osx)?-e10s$'), "name": "Talos g5 e10s"},
    {"regex": re.compile(r'talos g5(-osx)?$'), "name": "Talos g5"},
    ...
    {"regex": re.compile(r'talos quantum-pageload-stylo-e10s$'), "name": "Talos tp6-stylo e10s"},
    {"regex": re.compile(r'talos tp6-e10s$'), "name": "Talos tp6 e10s"},
    {"regex": re.compile(r'talos tp6-stylo-e10s$'), "name": "Talos tp6-stylo e10s"},
    {"regex": re.compile(r'talos tp6-stylo-threads-e10s$'), "name": "Talos tp6-stylo-threads e10s"},
...
GROUP_NAMES = {
    ...
    "Talos g4": "Talos Performance",
    "Talos g5": "Talos Performance",
    ...
    "Talos quantum-pageload-stylo e10s": "Talos Performance e10s",
    "Talos tp6 e10s": "Talos Performance e10s",
    "Talos tp6-stylo e10s": "Talos Performance e10s",
    "Talos tp6-stylo-threads e10s": "Talos Performance e10s",
...
SYMBOLS = {
    ...
    "Talos quantum-pageload-stylo e10s": "tp6s",
    "Talos tp6 e10s": "tp6",
    "Talos tp6-stylo e10s": "tp6s",
    "Talos tp6-stylo-threads e10s": "tp6st",
    # Release Promotion Related Jobs
