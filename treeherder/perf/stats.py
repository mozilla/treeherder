...
def interpret_ci(ci_low, ci_high, lower_is_better):
    is_regression = False
...
def interpret_cles(
    ...
    effect_size = interpret_effect_size(delta)
    ...
    return common_language_effect_size, cles, is_significant, effect_size, cles_explanation
...
def interpret_silverman_kde(base, new, lower_is_better):
    ...
    if base_mode_count == new_mode_count:
        ...
        for i, (start, end) in enumerate(base_intervals):
            ...
            is_regression, is_improvement, ci_intepretation = interpret_ci(
    ...
    return (silverman_kde, is_regression, is_improvement, more_runs_are_needed, warning_msgs)
