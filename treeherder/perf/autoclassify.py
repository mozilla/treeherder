...
def get_revision_from_hg(summary):
    ...
    for i in range(int(summary.result_set_id), int(summary.prev_result_set_id), -1):
        ...
        r = json.loads(make_request("https://hg.mozilla.org/integration/{}/json-pushes/?full=1&version=2&changeset={}".format(summary.repository.name, result_changeset)).text)
